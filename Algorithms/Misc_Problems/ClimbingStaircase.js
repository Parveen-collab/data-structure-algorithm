...
* If you have to climb to step **`n`**, you can only come from step **`n - 1`** or step **`n - 2`**.
* Calculate the number of ways to climb to **`n - 1`** and **`n - 2`** steps, then add them together.
